...
<head>
  ...
  <title>{{$seting['sitename']->content}}</title>
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">{{CRUDBooster::getSetting('appname')}}</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a class="get-started-btn" href="">{{CRUDBooster::myName()}}</a>
            <ul>
              <li><a href="/admin/users/profile">Редагувати профіль</a></li>
          ...
          @endif
          @if(!CRUDBooster::myName())
          <li class="drop-down"><a class="get-started-btn" href='{{route("getLogin")}}'>Увійти</a>
            <ul>
              <li><a href='{{route("getLogin")}}'>Увійти</a></li>
              <li><a href='/admin/register'>Реєстрація</a></li>
            </ul>
          </li>
          @endif
