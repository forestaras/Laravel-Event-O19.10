<?php namespace App\Http\Controllers;
	...
	class AdminEventdopController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "titlesilka";
			$this->limit = "20";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Titlesilka","name"=>"titlesilka"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Назва силки','name'=>'titlesilka','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Eventid','name'=>'eventid','value'=>$_GET['event'],'type'=>"hidden",'width'=>'col-sm-10','datatable'=>'event,id'];
			$this->form[] = ['label'=>'url','name'=>'text','type'=>'text','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Userid','name'=>'userid','type'=>"hidden",'width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Titlesilka","name"=>"titlesilka","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
	    public function hook_after_add($id) {        
	        $eventid=DB::table('eventdop')->where('id',$id)->first();
	    	

	    	CRUDBooster::redirect('/admin/event19/detail/'.$eventid->eventid,"Вами було додану лінку ".$eventid->titlesilka,"success");
